...
public interface PlacesGeoResources {
    /**
     * Find out more details of a place that was returned from the {@link twitter4j.api.PlacesGeoResources#reverseGeoCode(twitter4j.GeoQuery)} method.
     * <br>This method calls http://api.twitter.com/1.1/geo/id/:id.json
     *
     ...
     * <br>This method calls http://api.twitter.com/1.1/geo/reverse_geocode.json
     *
     ...
     * <br>This method calls http://api.twitter.com/1.1/geo/search.json
     *
     * @param query search query
     * @return places (cities and neighborhoods) that can be attached to a statuses/update
     * @throws TwitterException when Twitter service or network is unavailable
     ...
     * <br>This method calls http://api.twitter.com/1.1/geo/similar_places.json
     *
     ...
     * <br>This method calls http://api.twitter.com/1.1/geo/place.json
     *
     * @param name            The name a place is known as.
