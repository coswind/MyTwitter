...
public final class Crouton {
     ...
     *
     * @param activity The {@link android.app.Activity} that the {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be attached
     *                 to.
     * @param text     The text you want to display.
     * @param style    The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
     */
     ...
     * Creates the {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
     *
     * @param activity  The {@link android.app.Activity} that represents the context in which the Crouton should exist.
     * @param text      The text you want to display.
     * @param style     The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
     * @param viewGroup The {@link android.view.ViewGroup} that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be added to.
     */
     ...
     * @param customView    The custom {@link android.view.View} to display
     * @param viewGroup     The {@link android.view.ViewGroup} that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be added to.
     * @param configuration The {@link de.keyboardsurfer.android.widget.crouton.Configuration} for this {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
     */
     ...
     * @param text           The text you want to display.
     * @param style          The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
     * @param viewGroupResId The resource id of the {@link android.view.ViewGroup} that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be added to.
     * @return The created {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
     */
     ...
     *
     * @param activity The {@link android.app.Activity} that the {@link de.keyboardsurfer.android.widget.crouton.Crouton} should
     *                 be attached to.
     * @param text     The text you want to display.
     * @param style    The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
     */
     ...
     *
     * @param crouton The {@link de.keyboardsurfer.android.widget.crouton.Crouton} you want to hide.
     */
    ...
    public Animation getInAnimation() {
        if ((null == this.inAnimation) && (null != this.activity)) {
            if (getConfiguration().inAnimationResId > 0) {
                ...
                measureCroutonView();
                this.inAnimation = DefaultAnimationsBuilder.buildDefaultSlideInAnimation(getView(),
                        getConfiguration().viewGroupPosition == Configuration.POSITION_END);
            }
        }
    ...
    public Animation getOutAnimation() {
        if ((null == this.outAnimation) && (null != this.activity)) {
            if (getConfiguration().outAnimationResId > 0) {
                ...
                this.outAnimation = DefaultAnimationsBuilder.buildDefaultSlideOutAnimation(getView(),
                        getConfiguration().viewGroupPosition == Configuration.POSITION_END);
            }
        }
    ...
    /**
     * Set the {@link de.keyboardsurfer.android.widget.crouton.Configuration} on this {@link de.keyboardsurfer.android.widget.crouton.Crouton}, prior to showing it.
     *
     * @param configuration a {@link de.keyboardsurfer.android.widget.crouton.Configuration} built using the {@link de.keyboardsurfer.android.widget.crouton.Configuration.Builder}.
     * @return this {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
     */
