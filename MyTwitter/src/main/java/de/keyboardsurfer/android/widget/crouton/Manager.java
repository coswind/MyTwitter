...
final class Manager extends Handler {
     ...
     *
     * @param crouton The {@link de.keyboardsurfer.android.widget.crouton.Crouton} to be displayed.
     */
     ...
     *
     * @param crouton   The {@link de.keyboardsurfer.android.widget.crouton.Crouton} that should be sent.
     ...
     *
     * @param crouton The {@link de.keyboardsurfer.android.widget.crouton.Crouton} that should be added.
     */
    private void addCroutonToView(final Crouton crouton) {
        ...
        final int viewGroupPosition = crouton.getConfiguration().viewGroupPosition;
        if (null == croutonView.getParent()) {
            ...
            if (null != crouton.getViewGroup()) {
                ...
                if (viewGroupPosition == Configuration.POSITION_END) {
                    View view = crouton.getActivity().getWindow().getDecorView().findViewById(android.R.id.content);
                    if (view instanceof FrameLayout) {
                        FrameLayout frameLayout = (FrameLayout) view;
                        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                        layoutParams.gravity = Gravity.BOTTOM;
                        frameLayout.addView(croutonView, layoutParams);
                    }
                } else {
     ...
     *
     * @param crouton The {@link de.keyboardsurfer.android.widget.crouton.Crouton} added to a {@link android.view.ViewGroup} and should be
     *                removed.
     */
     ...
     * displayed.
     *
     * @param crouton The {@link de.keyboardsurfer.android.widget.crouton.Crouton} that should be removed.
     */
