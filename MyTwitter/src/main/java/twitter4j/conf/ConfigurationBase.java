...
class ConfigurationBase implements Configuration, java.io.Serializable {
    ...
    public void dumpConfiguration() {
        ...
        if (!includeRTsEnabled) {
            Logger.d("includeRTsEnabled is set to false. This configuration may not take effect after May 14th, 2012. https://dev.twitter.com/blog/api-housekeeping");
        }
        if (!includeEntitiesEnabled) {
            Logger.d("includeEntitiesEnabled is set to false. This configuration may not take effect after May 14th, 2012. https://dev.twitter.com/blog/api-housekeeping");
        }
    }
